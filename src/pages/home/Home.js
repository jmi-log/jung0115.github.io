...
const Home = ({ onSelectJmi, onSelectPosts, onSelectPortfolio }) => {
  const portfolios = [{"title": "마이꾸미", "period": "2024.04 ~ 2024.11 (8개월)", "goals": ["🏢 SW마에스트로 15기", "✅ Google Play Store 출시"], "backgroundColor": "#AEE7EB",
    ...
    {"title": "이루다", "period": "2023.07 ~ 2023.08 (2개월)", "goals": ["🏆 서울 우먼테크 해커톤 우수상"], "backgroundColor": "#BECAF0",
    ...
    {"title": "개발새발", "period": "2022.11 ~ 2023.01 (3개월)", "goals": ["✅ Google Play Store 출시"], "backgroundColor": "#E5D5F9",
    ...
    {"title": "감자톤 간식 게임 웹사이트", "period": "2023.09 ~ 2023.11 (3개월)", "goals": ["💻 2023 한림대 x 강원대 멋쟁이사자처럼 연합 해커톤 '감자톤' 운영"], "backgroundColor": "#F9E1CF",
